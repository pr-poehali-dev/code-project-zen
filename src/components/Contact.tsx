      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Присоединяйтесь
              <span className="block">к дискуссии</span>
            </h2>
            <p
            ...
            >
              Вы агроблогер, редактор или представитель бренда? Поделитесь своим взглядом на будущее агромедиа — мы публикуем лучшие точки зрения.
            </p>
            ...
            >
              ...
              <div>
                <p className="text-xs tracking-widest uppercase text-muted-foreground mb-2">Тема</p>
                <p className="text-foreground">Агромедиа · Блогеры · Традиционные СМИ</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ваша точка зрения на агромедиа..."
                  required
                />
              </div>
              <button
