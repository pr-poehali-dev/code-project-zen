      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4">
            <p className="font-serif text-2xl tracking-wide text-foreground mb-4">АгроМедиа</p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Агроблогеры vs традиционные медиа: конкуренты или союзники?
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} АгроМедиа. Все права защищены.
          </p>
          <p className="text-xs text-muted-foreground">Исследование медиаландшафта агросферы</p>
        </div>
      </div>
    </footer>
  )
